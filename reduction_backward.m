function [x_reduced, q, b_selected] = reduction_backward(x, p, k)
% Use method from Dupa?ov�, Jitka, Nicole Gr�we-Kuska, and Werner R�misch. 
...
for ik = 1: nS - k
    pc = inf.*ones(nS, 1); % Eqn. (16) from Dupa?ov� et al.
